...
int main() {
    ...
    foi(0,t){
        ...
        ll smallestnotseen = 0;
        vll smallchecker(n+1);
        fx(a){
            if(x<0){
                cout<<abs(x)+smallestnotseen << " ";
                smallchecker[abs(x)+smallestnotseen]=1;
                //update smallestnotseen;
            }
            else{
                cout << smallestnotseen << " ";
                smallchecker[smallestnotseen]=1;
                //update smallestnotseen;
            }
            if(smallchecker[smallestnotseen]==1){
                while(smallchecker[smallestnotseen]==1){
                    smallestnotseen++;
                }
            }
        }
