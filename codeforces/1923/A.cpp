...
auto solve(int testcases, const std::vector<long long> &a, const std::vector<std::vector<long long> > &b) {
    ...
    find first 1
    find last 1
    find all 0's between these 2
    by
    iterating from L to R counting sum
    then minus from R-L
     */
