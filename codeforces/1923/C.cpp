...
#define fo(from_0_to_non_incl_to) for(ll i=0;i<from_0_to_non_incl_to;i++)
#define foi(from,non_incl_to) for(ll i=from;i<non_incl_to;i++)
#define foj(from,non_incl_to) for(ll j=from;j<non_incl_to;j++)
#define fok(from,non_incl_to) for(ll k=from;k<non_incl_to;k++)
...
int main() {
    ...
    foi(0,t){
        ...
        foi(0,q){
            ...
            cin >> l >> r;
            --l;
            //if(r-l==0) cout << "NO" << endl;
            /* cerr << pc[r] - pc[l] << endl;
            cerr << pco[r] - pco[l] << endl;
            cerr << endl; */
