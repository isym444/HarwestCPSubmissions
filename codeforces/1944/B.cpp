...
int main() {
    ...
    foi(0,t){
        ...
        set<ll> aseen;
        set<ll> bseen;
        vector<long long> testing;
        vector<long long> avdouble;
        vector<long long> bvdouble;
        set<ll> bdouble;
        set<ll> adouble;
        vll asingle;
        vll bsingle;
        ...
        //cerr << "adouble: " << adouble << endl;
        //cerr << "adouble: " << (adouble.find((ll)2)==adouble.end()) << endl;
        foj(0,n){
            if(adouble.find((ll)a[j])==adouble.end()){
                asingle.pb(a[j]);
            }
        }
        foj(n,2*n){
        ...
        foj(0,n){
            if(bdouble.find((ll)b[j])==bdouble.end()){
                bsingle.pb(b[j]);
            }
        }
        sort(asingle.begin(), asingle.end());
        sort(bsingle.begin(), bsingle.end());
        /* cerr << "asingle: " << asingle << endl;
        cerr << "avdouble: " << avdouble << endl;
        cerr << "bsingle: " << bsingle << endl;
        cerr << "bvdouble: " << bvdouble << endl;
        cerr << "bdouble: " << bdouble << endl;
        cerr << endl; */
        foj(0,2*k){
            if(!avdouble.empty()){
                //cerr << avdouble.empty() << endl;
                if(j<avdouble.size()){
                    cout << avdouble[j] << " ";
                }
                else{
                    //cerr << "hh: " << avdouble.size() << endl;
                    cout << asingle[j-avdouble.size()] << " ";
                }
            }
            else{
                cout << asingle[j] << " ";
        ...
        foj(0,2*k){
            if(!bvdouble.empty()){
                //cerr << bvdouble.empty() << endl;
                if(j<bvdouble.size()){
                    cout << bvdouble[j] << " ";
                }
                else{
                    //cerr << "hh: " << bvdouble.size() << endl;
                    cout << bsingle[j-bvdouble.size()] << " ";
                }
            }
            else{
                    cout << bsingle[j] << " ";
